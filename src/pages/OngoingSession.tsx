...
const QAMentorSession: React.FC = () => {
	return (
		<div className="p-8 min-h-screen flex flex-col items-left">
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-12 mt-[60px]">
				{participants.map((participant, idx) => (
					<div
						key={idx}
						className="bg-background-100 rounded-lg p-14 shadow-box-shadow1 flex flex-col items-center relative"
					>
